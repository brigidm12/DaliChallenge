...
// import './WeatherDashboard.css'; // Import your local CSS file

// function WeatherDashboard() {
//   return (
//     <div id="weatherContainer" className="container mb-3 mt-3">
//       <div id="weather" className="row">
//         <div id="title" className="col-12 title text-center font-weight-bold">
//           <h1>Weather Dashboard</h1>
//         </div>
//       </div>
//       <div className="row">
//         <div id="zipCodeContainer" className="col-4 zipCode text-left font-weight-bold">
//           <p>Search for a City:</p>
//           <div className="input-group">
//             <input id="zipCode" type="search" className="form-control rounded" placeholder="Search" aria-label="Search"
//               aria-describedby="search-addon" />
//             <button id="searchBtn" type="button" className="SearchBtn btn-outline-primary">search</button>
//           </div>
//           <div id="locationHistory" className="list-group">
//           </div>
//         </div>
//         <div className="col-8 h-50 pr-0 pt-3">
//           <div id="weatherData">
//             <div id="currentWeather" className="border-light">
//               <div className="card">
//                 <div className="card-body">
//                   <h5 id="cityDate" className="card-title"></h5>
//                   <p className="card-text"><span>Temperature: </span><span id="currentTemp"></span></p>
//                   <p className="card-text"><span>Humidity: </span><span id="currentHumidity"></span></p>
//                   <p className="card-text"><span>Wind Speed: </span><span id="currentWindSpeed"></span></p>
//                   <p className="card-text"><span>UV Index: </span><span id="currentUVIndex" className="d-inline-block"></span></p>
//                 </div>
//               </div>
//             </div>
//             <div id="5DayWeather">
...
//               <div>
//                 <div id="fiveDay" className="d-flex justify-content-between">
//                 </div>
//               </div>
//             </div>
//           </div>
